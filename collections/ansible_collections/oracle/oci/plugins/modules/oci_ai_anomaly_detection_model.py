...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_ai_anomaly_detection_model_module.html)
    ...
    module_args.update(
        dict(
            ...
            model_training_details=dict(
                ...
                options=dict(
                    algorithm_hint=dict(
                        type="str", choices=["MULTIVARIATE_MSET", "UNIVARIATE_OCSVM"]
                    ),
