...
DOCUMENTATION = """
---
module: oci_ai_anomaly_detection_project
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_ai_anomaly_detection_project_module.html)
...
try:
    ...
    from oci.ai_anomaly_detection.models import CreateProjectDetails
    from oci.ai_anomaly_detection.models import UpdateProjectDetails
...
class ProjectHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(ProjectHelperGen, self).get_possible_entity_types() + [
            ...
            "aianomalydetectionprojects",
            "aiAnomalyDetectionaianomalydetectionproject",
            "aiAnomalyDetectionaianomalydetectionprojects",
            "aianomalydetectionprojectresource",
            "aianomalydetectionprojectsresource",
            "project",
            "projects",
            "aiAnomalyDetectionproject",
            "aiAnomalyDetectionprojects",
