...
DOCUMENTATION = """
---
module: oci_ai_language_project
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_ai_language_project_module.html)
...
try:
    ...
    from oci.ai_language.models import UpdateProjectDetails
...
class AiLanguageProjectHelperGen(OCIResourceHelperBase):
    """Supported operations: create, update, get, list and delete"""

    def get_possible_entity_types(self):
        return super(AiLanguageProjectHelperGen, self).get_possible_entity_types() + [
            "ailanguageproject",
            "ailanguageprojects",
            "aiLanguageailanguageproject",
            "aiLanguageailanguageprojects",
            "ailanguageprojectresource",
    ...
    def get_optional_kwargs_for_list(self):
        optional_list_method_params = ["display_name", "project_id"]
...
AiLanguageProjectHelperCustom = get_custom_class("AiLanguageProjectHelperCustom")


class ResourceHelper(AiLanguageProjectHelperCustom, AiLanguageProjectHelperGen):
    pass
