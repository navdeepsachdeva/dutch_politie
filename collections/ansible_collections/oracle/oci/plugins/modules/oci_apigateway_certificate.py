...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_apigateway_certificate_module.html)
...
class ApigatewayCertificateHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(
            ApigatewayCertificateHelperGen, self
        ).get_possible_entity_types() + [
            "apigatewaycertificate",
            "apigatewaycertificates",
            "apigatewayapigatewaycertificate",
            "apigatewayapigatewaycertificates",
            "apigatewaycertificateresource",
            "apigatewaycertificatesresource",
            "certificate",
            "certificates",
            "certificateresource",
