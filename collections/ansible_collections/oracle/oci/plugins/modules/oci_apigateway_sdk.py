...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_apigateway_sdk_module.html)
...
class ApigatewaySdkHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(ApigatewaySdkHelperGen, self).get_possible_entity_types() + [
            "apigatewaysdk",
            "apigatewaysdks",
            "apigatewayapigatewaysdk",
            "apigatewayapigatewaysdks",
            "apigatewaysdkresource",
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_sdk, sdk_id=summary_model.id,
        ).data
