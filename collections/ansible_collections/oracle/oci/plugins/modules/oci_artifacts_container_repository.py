...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_artifacts_container_repository_module.html)
...
class ContainerRepositoryHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(ContainerRepositoryHelperGen, self).get_possible_entity_types() + [
            "containerrepository",
            "containerrepositories",
            "artifactscontainerrepository",
            "artifactscontainerrepositories",
            "containerrepositoryresource",
            "containerrepositoriesresource",
            "repository",
            "repositories",
            "artifactsrepository",
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_container_repository, repository_id=summary_model.id,
        ).data
