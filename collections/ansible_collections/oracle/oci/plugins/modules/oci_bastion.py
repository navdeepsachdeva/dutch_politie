...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_bastion_module.html)
...
class BastionHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(BastionHelperGen, self).get_possible_entity_types() + [
            "bastion",
            "bastions",
            "bastionbastion",
            "bastionbastions",
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_bastion, bastion_id=summary_model.id,
        ).data
