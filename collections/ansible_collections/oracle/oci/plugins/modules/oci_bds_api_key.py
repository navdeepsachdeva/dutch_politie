...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_bds_api_key_module.html)
...
class BdsApiKeyHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(BdsApiKeyHelperGen, self).get_possible_entity_types() + [
            "bdsapikey",
            "bdsapikeys",
            "bdsbdsapikey",
            "bdsbdsapikeys",
