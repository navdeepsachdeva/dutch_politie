...
DOCUMENTATION = """
---
module: oci_cloud_bridge_agent_facts
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_cloud_bridge_agent_facts_module.html)
    ...
    module_args.update(
        dict(
            ...
            lifecycle_state=dict(
                type="str",
                choices=["CREATING", "ACTIVE", "INACTIVE", "DELETED", "FAILED"],
            ),
