...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_data_catalog_metastore_module.html)
...
class DataCatalogMetastoreHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(
            DataCatalogMetastoreHelperGen, self
        ).get_possible_entity_types() + [
            "metastore",
            "metastores",
            "dataCatalogmetastore",
            "dataCatalogmetastores",
            "metastoreresource",
            "metastoresresource",
            "datacatalog",
        ]
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_metastore, metastore_id=summary_model.id,
        ).data
