...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_data_catalog_type_actions_module.html)
...
def main():
    ...
    module_args.update(
        dict(
            ...
            type_key=dict(type="str", required=True, no_log=True),
            custom_property_ids=dict(type="list", elements="str"),
