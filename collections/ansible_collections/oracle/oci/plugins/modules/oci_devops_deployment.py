...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_devops_deployment_module.html)
...
class DevopsDeploymentHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(DevopsDeploymentHelperGen, self).get_possible_entity_types() + [
            ...
            "devopsdevopsdeployments",
            "devopsdeploymentresource",
            "devopsdeploymentsresource",
            "deployment",
            "deployments",
            "deploymentresource",
            "deploymentsresource",
