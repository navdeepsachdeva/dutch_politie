...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_email_sender_module.html)
...
class SenderHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(SenderHelperGen, self).get_possible_entity_types() + [
            "sender",
            "senders",
            "emailsender",
            "emailsenders",
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_sender, sender_id=summary_model.id,
        ).data
