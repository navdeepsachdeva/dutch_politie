...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_healthchecks_http_monitor_module.html)
...
class HttpMonitorHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(HttpMonitorHelperGen, self).get_possible_entity_types() + [
            "httpmonitor",
            "httpmonitors",
            "healthcheckshttpmonitor",
            "healthcheckshttpmonitors",
            "httpmonitorresource",
            "httpmonitorsresource",
            "healthchecks",
        ]
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_http_monitor, monitor_id=summary_model.id,
        ).data
