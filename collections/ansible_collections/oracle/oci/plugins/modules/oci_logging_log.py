...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_logging_log_module.html)
...
class LogHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(LogHelperGen, self).get_possible_entity_types() + [
            "log",
            "logs",
            "logginglog",
            "logginglogs",
