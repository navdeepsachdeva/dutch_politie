...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_logging_log_group_module.html)
...
class LogGroupHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(LogGroupHelperGen, self).get_possible_entity_types() + [
            "loggroup",
            "loggroups",
            "loggingloggroup",
            "loggingloggroups",
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_log_group, log_group_id=summary_model.id,
        ).data
