...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_mysql_backup_module.html)
...
class MysqlBackupHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(MysqlBackupHelperGen, self).get_possible_entity_types() + [
            "backup",
            "backups",
            "mysqlbackup",
            "mysqlbackups",
