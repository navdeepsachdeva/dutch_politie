...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_mysql_shape_facts_module.html)
    ...
    module_args.update(
        dict(
            ...
            is_supported_for=dict(
                type="list", elements="str", choices=["DBSYSTEM", "HEATWAVECLUSTER"]
            ),
