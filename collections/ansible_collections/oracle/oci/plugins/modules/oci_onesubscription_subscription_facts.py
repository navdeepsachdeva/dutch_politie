...
DOCUMENTATION = """
---
module: oci_onesubscription_subscription_facts
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_onesubscription_subscription_facts_module.html)
