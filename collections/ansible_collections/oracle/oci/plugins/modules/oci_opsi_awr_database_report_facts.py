...
DOCUMENTATION = """
---
module: oci_opsi_awr_database_report_facts
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_opsi_awr_database_report_facts_module.html)
...
class AwrDatabaseReportFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def get_resource(self):
        ...
        return oci_common_utils.call_with_backoff(
            self.client.get_awr_database_report,
...
AwrDatabaseReportFactsHelperCustom = get_custom_class(
    "AwrDatabaseReportFactsHelperCustom"
)


class ResourceFactsHelper(
    AwrDatabaseReportFactsHelperCustom, AwrDatabaseReportFactsHelperGen
):
    pass
...
def main():
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="awr_database_report",
    ...
    module.exit_json(awr_database_report=result)
