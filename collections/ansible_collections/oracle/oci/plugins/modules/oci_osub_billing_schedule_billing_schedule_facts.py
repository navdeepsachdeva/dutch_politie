...
DOCUMENTATION = """
---
module: oci_osub_billing_schedule_billing_schedule_facts
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_osub_billing_schedule_billing_schedule_facts_module.html)
...
def main():
    ...
    resource_facts_helper = ResourceFactsHelper(
        ...
        namespace="osub_billing_schedule",
    )
