...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_service_catalog_module.html)
...
class ServiceCatalogHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(ServiceCatalogHelperGen, self).get_possible_entity_types() + [
            "servicecatalog",
            "servicecatalogs",
            "serviceCatalogservicecatalog",
            "serviceCatalogservicecatalogs",
            "servicecatalogresource",
            "servicecatalogsresource",
        ]
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_service_catalog, service_catalog_id=summary_model.id,
        ).data
