...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_streaming_stream_module.html)
...
class StreamHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(StreamHelperGen, self).get_possible_entity_types() + [
            "stream",
            "streams",
            "streamingstream",
            "streamingstreams",
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_stream, stream_id=summary_model.id,
        ).data
