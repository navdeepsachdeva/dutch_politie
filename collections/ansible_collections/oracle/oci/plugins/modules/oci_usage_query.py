...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_usage_query_module.html)
...
class QueryHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(QueryHelperGen, self).get_possible_entity_types() + [
            "query",
            "queries",
            "usageApiquery",
            "usageApiqueries",
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_query, query_id=summary_model.id,
        ).data
