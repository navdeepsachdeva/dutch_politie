...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_waas_certificate_module.html)
...
class WaasCertificateHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(WaasCertificateHelperGen, self).get_possible_entity_types() + [
            "waascertificate",
            "waascertificates",
            "waaswaascertificate",
            "waaswaascertificates",
            "waascertificateresource",
