...
DOCUMENTATION = """
---
module: oci_waas_device_fingerprint_challenge
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_waas_device_fingerprint_challenge_module.html)
...
try:
    ...
    from oci.waas.models import DeviceFingerprintChallenge
...
class DeviceFingerprintChallengeHelperGen(OCIResourceHelperBase):
    ...
    def get_get_fn(self):
        return self.client.get_device_fingerprint_challenge
    ...
    def update_resource(self):
        ...
        return oci_wait_utils.call_and_wait(
            call_fn=self.client.update_device_fingerprint_challenge,
            call_fn_args=(),
            call_fn_kwargs=dict(
                waas_policy_id=self.module.params.get("waas_policy_id"),
                update_device_fingerprint_challenge_details=update_details,
            ),
...
DeviceFingerprintChallengeHelperCustom = get_custom_class(
    "DeviceFingerprintChallengeHelperCustom"
)


class ResourceHelper(
    DeviceFingerprintChallengeHelperCustom, DeviceFingerprintChallengeHelperGen
):
    pass
